...
const navigation = [
  { name: 'Home', href: '/users/dashboard', icon: HomeIcon, current: false },
  { name: 'Company Registration', href: '/users/companyRegistration', icon: FolderMinusIcon, current: false },
                        ...
                        <div className="mt-1 space-y-1" role="group" aria-labelledby="mobile-teams-headline">
                          {supports.map((team) => (
                            ...
                            >
                              ...
                              <team.icon
                              className={classNames(
                                  team.current ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500',
                                  'mr-3 flex-shrink-0 h-6 w-6'
                                )}
                                aria-hidden="true"
                              />
              ...
              <div className="mx-auto py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
                ...
                <div className="mt-8 md:order-1 md:mt-0">
                  <p className="text-center text-xs leading-5 text-gray-500">
                    &copy; 2023 KECS, Inc. All rights reserved.
                  </p>
                </div>
              </div>
            </footer>
