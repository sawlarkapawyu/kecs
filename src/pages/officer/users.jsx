...
const UsersPage = () => {
    const users = [
    { user_name: 'Lindsay', email: 'lindsay@example.com', id_number: '3/kakaya(na)123221',  status: 'Pending' },
    { user_name: 'Walton', email: 'walton@example.com', id_number: '3/kakaya(na)123221',  status: 'Approved' },
    // More people...
    ]
        ...
        <Sidebar>
            ...
            <div className="px-4 py-4 sm:px-6 lg:px-8">
                <div className="sm:flex sm:items-center">
                    ...
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Users Management</h1>
                    ...
                    <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <table className="min-w-full divide-y divide-gray-300">
                            ...
                            {users.map((person) => (
                                ...
                                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{person.id_number}</td>
                                ...
                                <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    ...
                                    View<span className="sr-only">, {person.user_name}</span>
                                    </a>
                                    <a href="#" className="text-sky-600 hover:text-sky-900">
                                    Edit<span className="sr-only">, {person.user_name}</span>
                                    </a>
                                </td>
                                </tr>
                            ))}
